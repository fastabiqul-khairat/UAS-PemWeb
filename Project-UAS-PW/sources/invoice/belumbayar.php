...
<html>
<head>
	<title>BERKAH SELALU &middot; Invoice - <?php echo $row['NoTagihan']; ?></title>
	<style type="text/css">
		* {
			margin:0;
		}
...
<body style="font-family: sans-serif;">
	<div style="background-color: #fafafa;padding: 20px;width:80%">
		...
		<tr>
			<td colspan="4">
				<h2 style="margin-bottom:30px;">PT. PLN BERKAH SELALU</h2>
				<tr>
					<td style="font-weight: bold;font-size:14px;">Alamat</td>
					<td colspan="3">Jln. jalanin aja No.40, Cengkareng, Jakarta Barat</td>			
					<td></td>
				...
				<tr>
					...
					<td colspan="3">berkahselalu@pln.co.id</td>			
					<td></td>
		...
		<tr>
			<td colspan="7" style="padding:20px 0;">
				Silahkan melakukan pembayaran sejumlah <em><?php echo "Rp ".number_format($row['TotalBayar'], 0, '','.'); ?></em> ke Rekening BCA (09875654456), sampai batas akhir tanggal 1 - 10 di awal Bulan.
			</td>
		</tr>	
		<tr>
			<td colspan="6"></td>
