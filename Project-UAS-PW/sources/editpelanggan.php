<?php 
	...
	require_once "sources/HeaderFooter/header.php";
	...
	<div class="card-body">
		<form action="index.php?process=editpelanggan" method="POST" class="form-block">
			...
			<div class="form-group">
				...
				<input type="text" class="input" id="Password" name="Password" value="<?php echo $plg['Password']; ?>">
			</div>
			<div class="form-group">
...
<?php
	...
	require_once "sources/HeaderFooter/footer.php";
?>